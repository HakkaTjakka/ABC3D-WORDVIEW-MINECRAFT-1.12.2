#/execute @e[r=10] ~ ~ ~ particle explode ~ ~ ~ 16 16 16 0.1 5000
#/function abc:rails_a if @e[r=10]
...
fill ~-16 ~16 ~ ~-16 ~16 ~ repeating_command_block 0 keep {Command:"function abc:rails_c if @e[r=40]",auto:1b}
fill ~16 ~16 ~ ~16 ~16 ~ repeating_command_block 0 keep {Command:"function abc:rails_a if @e[r=40]",auto:1b}
...
#fill ~16 ~ ~ ~16 ~ ~ repeating_command_block 0 keep {Command:"function abc:test_bedrock",auto:1b}
#fill ~-16 ~ ~ ~-16 ~ ~ repeating_command_block 0 keep {Command:"function abc:test_bedrock",auto:1b}
...
fill ~-64 ~ ~ ~-64 ~ ~ repeating_command_block 0 keep {Command:"function abc:test2 if @e[r=40]",auto:1b}
fill ~64 ~ ~ ~64 ~ ~ repeating_command_block 0 keep {Command:"function abc:test2 if @e[r=40]",auto:1b}
fill ~ ~ ~-64 ~ ~ ~-64 repeating_command_block 0 keep {Command:"function abc:test2 if @e[r=40]",auto:1b}
fill ~ ~ ~64 ~ ~ ~64 repeating_command_block 0 keep {Command:"function abc:test2 if @e[r=40]",auto:1b}
...
fill ~ ~32 ~ ~ ~32 ~ repeating_command_block 0 keep {Command:"function abc:test if @e[r=40]",auto:1b}
...
fill ~ ~-9 ~ ~ ~-9 ~ repeating_command_block 0 keep {Command:"function abc:test_bedrock_sub",auto:1b}
fill ~ ~-9 ~ ~ ~-9 ~ air 0 replace planks 0

#function abc:test_bedrock
...
#fill ~ ~ ~ ~-1 ~ ~-1 concrete 1
fill ~1 ~1 ~1 ~-2 ~-1 ~-2 glass 0 hollow
...
#fill ~ ~ ~ ~ ~ ~ repeating_command_block 0 keep {Command:"function abc:test_lat if @e[r=40]",auto:1b}
...
fill ~ 253 ~ ~ 253 ~ repeating_command_block 0 keep {Command:"function abc:do_roof",auto:1b}
