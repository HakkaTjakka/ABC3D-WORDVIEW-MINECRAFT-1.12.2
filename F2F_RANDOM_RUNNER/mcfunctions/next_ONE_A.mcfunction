...
fill ~-1 ~-5 ~3 ~-1 ~-5 ~3 command_block 0 keep {Command:"function abc:NEXT_F_F"}
...
setblock ~4 ~-4 ~4 light_weighted_pressure_plate 0 keep
fill ~5 ~-5 ~3 ~5 ~-5 ~3 command_block 0 keep {Command:"function abc:NEXT_L_B"}
setblock ~5 ~-4 ~3 light_weighted_pressure_plate 0 keep
fill ~6 ~-5 ~4 ~6 ~-5 ~4 command_block 0 keep {Command:"function abc:NEXT_M_W"}
setblock ~6 ~-4 ~4 light_weighted_pressure_plate 0 keep
